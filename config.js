...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '06_04_H_E_R_M_I_T_GQ_E08U',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Yasir Khan;923211865537;',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Yasir Khan;' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Yasir Khan' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923211865537,0',
       DEBUG: DEBUG
};
